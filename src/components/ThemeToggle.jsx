export function ThemeToggle({ theme, onToggle }) {
  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center w-14 h-7 rounded-full motion-safe:transition-colors motion-safe:duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-slate-800 ${isDark ? 'bg-indigo-400' : 'bg-gray-300'}`}
    >
      {/* sliding knob */}
      <span
        className={`
